...
//        updateDrawInfo(1,[0.0,0.0,0.0, -20,0.0,-50.0, 1.0,1.0,1.0]);
    ...
    TextureArray[2]={ifTexture:0.0,TextureUrl:'none',n:3};
    ...
    TextureArray[5]={ifTexture:1.0,TextureUrl:'./textTures/wood11.jpg',n:1};
    ...
    TextureArray[6]={ifTexture:1.0,TextureUrl:'./textTures/wood2.jpg',n:2};
    ...
    TextureArray[7]={ifTexture:1.0,TextureUrl:'./textTures/wood2.jpg',n:3};
    ...
    TextureArray[8]={ifTexture:1.0,TextureUrl:'repeat',n:3};
    ...
    TextureArray[13]={ifTexture:1.0,TextureUrl:'./textTures/2048.jpg',n:4};
    ...
    readOBJFile('./models/lamp.obj', modelObject,  mtlArray, objArray, 0.003, false, 15);
    TextureArray[15]={ifTexture:1.0,TextureUrl:'repeat',n:0};
    updateDrawInfo(15,[0.0,-90.0,0.0, -8,-2.0,-14.3, 1,0.8,1,  0.2,0.2,0.2,1,1 ,1]);

    readOBJFile('./models/lamp.obj', modelObject,  mtlArray, objArray, 0.003, false, 16);
    TextureArray[16]={ifTexture:1.0,TextureUrl:'repeat',n:0};
    updateDrawInfo(16,[0.0,-90.0,0.0, -8,-2,14.3, 1,0.8,1,  0.2,0.2,0.2,1,1 ,1]);
